  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Balance Inquiry</a>
        </li>
...
<form action="changepinprocess" method="post" class="row g-3 needs-validation" novalidate>
  ...
  <div class="col-12">
    <button class="btn btn-primary" type="submit">proceed to set new password</button>
  </div>
</form>
</body>
</html>