...
<form action="withdrawalpage" method="post" class="row g-3 needs-validation" novalidate>

  <div class="col-md-4">
    <label for="validationCustom01" class="form-label">Account Number</label>
    <input type="text" class="form-control"  name="accountnumber" value="${accountnumber}" required>
  ...
  <div class="col-md-4">
    <label for="validationCustom02" class="form-label">Withdrawal amount</label>
    <input type="text" class="form-control" name="withdrawl" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
  ...
  <div class="col-12">
    <button class="btn btn-primary" type="submit">WITHDRAWAL</button>
  </div>
</form>
</body>
</html>