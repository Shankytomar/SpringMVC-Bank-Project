...
<div class="card text-bg-primary mb-3" style="max-width: 18rem;">
  ...
  <div class="card-body">
    <h5 class="card-title">${user.accountnumber}</h5>
    <p class="card-text">Welcome now you are part of our bank</p>
  </div>
</div>
<div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">do not share and change your pin.</p>
  </div>
</div>
<div id="create-account-wrap">
    <button onclick="location.href='homebutton'">Go to home page</button>
  </div>
</body>
</html>